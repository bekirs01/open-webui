...
>
	{#if confirmEdit}
		<div
			...
			confirmEdit
				...
				: selected
					? 'bg-gray-100 dark:bg-neutral-800/95 selected'
					: 'group-hover:bg-gray-100 dark:group-hover:bg-neutral-800/80'}  whitespace-nowrap text-ellipsis relative {generating
				? 'cursor-not-allowed'
				: ''}"
		>
			<input
	...
	{:else}
		<a
			...
			confirmEdit
				...
				: selected
					? 'bg-gray-100 dark:bg-neutral-800/95 selected'
					: ' group-hover:bg-gray-100 dark:group-hover:bg-neutral-800/80'}  whitespace-nowrap text-ellipsis"
			href="/c/{id}"
			on:click={() => {
				dispatch('select');
	...
	<div
        ...
        {id === $chatId || confirmEdit
			? 'from-gray-100 dark:from-neutral-800 selected'
			: selected
				? 'from-gray-100 dark:from-neutral-800/95 selected'
				: 'invisible group-hover:visible from-gray-100 dark:from-neutral-800/80'}
